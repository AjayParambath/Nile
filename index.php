...
<body class="n-nomargin"  >
  <!-- Nav Bar -->
    ...
    <div class="n-content" >
      <div class="n-categories" style="background-color: coral";>
        Categories
        <ul>
      ...
      <img class="n-image" align="n-center"src="https://pbs.twimg.com/profile_images/852143274504716289/2moYOBhZ.jpg" alt="">
    </div>
